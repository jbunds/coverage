	...
	tests := []struct {
	...
	}{
		{
			...
			want: strings.Join([]string{
				...
				`<pre>`,
				`<span class="line">package main`,
				`</span><span class="line">`,
				`</span><span class="line">import &#34;fmt&#34;`,
				`</span><span class="line">`,
				`</span><span class="line"><span class="hit">func main() {`,
				`</span></span><span class="line"><span class="hit">  fmt.Println(&#34;hello world&#34;)`,
				`</span></span><span class="line"><span class="hit">}`,
				`</span></span></pre>`,
				`<script>`,
				`try {`,
