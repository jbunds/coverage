	...
	tests := []struct {
	...
	}{
		{
			...
			want: strings.Join([]string{
				...
				`<pre>`,
				`<div class="line">package main`,
				`</div><div class="line">`,
				`</div><div class="line">import &#34;fmt&#34;`,
				`</div><div class="line">`,
				`</div><div class="line"><span class="hit">func main() {`,
				`</span></div><div class="line"><span class="hit">  fmt.Println(&#34;hello world&#34;)`,
				`</span></div><div class="line"><span class="hit">}`,
				`</span></div></pre>`,
				`<script>`,
				`try {`,
