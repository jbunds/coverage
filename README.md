...
- <svg width="72" height="24" viewBox="0 0 80 30"><rect x="0"  y="0"  width="70" height="30" rx="4" ry="4" fill="#606060" /><text x="36" y="20" font-family="Arial" font-size="16" fill="white" text-anchor="middle">expand</text></svg> toggle between a fully-collapsed and fully-expanded source tree
- &nbsp;<svg width="60" height="24" viewBox="0 0 80 30"><rect x="0"  y="0"  width="60" height="30" rx="4" ry="4" fill="#606060" /><text x="30" y="20" font-family="Arial" font-size="16" fill="white" text-anchor="middle">lines</text></svg>&nbsp; toggles showing or hiding a column of line numbers along the left side of the source code
- <svg width="68" height="24" viewBox="0 0 80 30"><rect x="0"  y="0"  width="68" height="30" rx="4" ry="4" fill="#606060" /><text x="35" y="20" font-family="Arial" font-size="16" fill="white" text-anchor="middle">theme</text></svg> toggle between **light** and **dark** themes
...
The motivation behind the `coverage` module was to provide a richer UI than that produced by `go tool cover -html`, with minimal JavaScript (71 lines total as of this writing, all of which is either trivial button event-listener boilerplate used to toggle CSS selectors, or theme preference persistence).
